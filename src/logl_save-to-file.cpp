        ...
        void draw(App_State const& as) {
...

            {
                auto setVec3 = [&](const char* name, float x, float y, float z) {
                    gl::Uniform_vec3 u{color_prog, name};
                    gl::Uniform(u, {x, y, z});
                };
                ...
                auto setFloat = [&](const char* name, float v) {
                    gl::Uniform_float u{color_prog, name};
                    gl::Uniform(u, v);
                };
